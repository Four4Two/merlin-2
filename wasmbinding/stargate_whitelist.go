...
import (
	...
	concentratedliquidityquery "github.com/four4two/merlin/v17/x/concentrated-liquidity/client/queryproto"
	downtimequerytypes "github.com/four4two/merlin/v17/x/downtime-detector/client/queryproto"
	...
	poolmanagerqueryproto "github.com/four4two/merlin/v17/x/poolmanager/client/queryproto"
	...
	twapquerytypes "github.com/four4two/merlin/v17/x/twap/client/queryproto"
...
func init() {
	...
	// gamm
	setWhitelistedQuery("/merlin.gamm.v1beta1.Query/NumPools", &gammtypes.QueryNumPoolsResponse{}) // ==> use x/poolmanager
	setWhitelistedQuery("/merlin.gamm.v1beta1.Query/TotalLiquidity", &gammtypes.QueryTotalLiquidityResponse{})
	setWhitelistedQuery("/merlin.gamm.v1beta1.Query/Pool", &gammtypes.QueryPoolResponse{}) // ==> use x/poolmanager
	setWhitelistedQuery("/merlin.gamm.v1beta1.Query/PoolParams", &gammtypes.QueryPoolParamsResponse{})
	setWhitelistedQuery("/merlin.gamm.v1beta1.Query/TotalPoolLiquidity", &gammtypes.QueryTotalPoolLiquidityResponse{}) // ==> use x/poolmanager
	...
	setWhitelistedQuery("/merlin.gamm.v1beta1.Query/EstimateSwapExactAmountIn", &gammtypes.QuerySwapExactAmountInResponse{})   // ==> use x/poolmanager
	setWhitelistedQuery("/merlin.gamm.v1beta1.Query/EstimateSwapExactAmountOut", &gammtypes.QuerySwapExactAmountOutResponse{}) // ==> use x/poolmanager
	...
	setWhitelistedQuery("/merlin.poolmanager.v1beta1.Query/TotalPoolLiquidity", &poolmanagerqueryproto.TotalPoolLiquidityResponse{})
