...
merlin init test
wget -O ~/.merlin/config/genesis.json https://github.com/four4two/merlin/raw/main/networks/merlin-1/genesis.json
...
export MERLIN_STATESYNC_RPC_SERVERS="https://rpc.merlin.zone:443,https://rpc.merlin.zone:443"
