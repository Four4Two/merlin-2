...
import (
	...
	migration "github.com/four4two/merlin/v16/x/gamm/types/migration"
	types2 "github.com/four4two/merlin/v16/x/poolmanager/types"
...
func init() {
	...
	proto.RegisterType((*QueryCFMMConcentratedPoolLinksRequest)(nil), "merlin.gamm.v1beta1.QueryCFMMConcentratedPoolLinksRequest")
	proto.RegisterType((*QueryCFMMConcentratedPoolLinksResponse)(nil), "merlin.gamm.v1beta1.QueryCFMMConcentratedPoolLinksResponse")
}
...
func (c *queryClient) CFMMConcentratedPoolLinks(ctx context.Context, in *QueryCFMMConcentratedPoolLinksRequest, opts ...grpc.CallOption) (*QueryCFMMConcentratedPoolLinksResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.gamm.v1beta1.Query/CFMMConcentratedPoolLinks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_CFMMConcentratedPoolLinks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.gamm.v1beta1.Query/CFMMConcentratedPoolLinks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
