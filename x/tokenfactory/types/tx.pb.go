...
func init() {
	...
	proto.RegisterType((*MsgSetBeforeSendHook)(nil), "merlin.tokenfactory.v1beta1.MsgSetBeforeSendHook")
	proto.RegisterType((*MsgSetBeforeSendHookResponse)(nil), "merlin.tokenfactory.v1beta1.MsgSetBeforeSendHookResponse")
...
func (c *msgClient) SetBeforeSendHook(ctx context.Context, in *MsgSetBeforeSendHook, opts ...grpc.CallOption) (*MsgSetBeforeSendHookResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.tokenfactory.v1beta1.Msg/SetBeforeSendHook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetBeforeSendHook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.tokenfactory.v1beta1.Msg/SetBeforeSendHook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
