...
func init() {
	...
	proto.RegisterType((*QueryBeforeSendHookAddressRequest)(nil), "merlin.tokenfactory.v1beta1.QueryBeforeSendHookAddressRequest")
	proto.RegisterType((*QueryBeforeSendHookAddressResponse)(nil), "merlin.tokenfactory.v1beta1.QueryBeforeSendHookAddressResponse")
}
...
func (c *queryClient) BeforeSendHookAddress(ctx context.Context, in *QueryBeforeSendHookAddressRequest, opts ...grpc.CallOption) (*QueryBeforeSendHookAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.tokenfactory.v1beta1.Query/BeforeSendHookAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_BeforeSendHookAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.tokenfactory.v1beta1.Query/BeforeSendHookAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
