...
import (
	...
	types "github.com/four4two/merlin/v16/x/poolmanager/types"
...
func init() {
	...
	proto.RegisterType((*EstimateSwapExactAmountInWithPrimitiveTypesRequest)(nil), "merlin.poolmanager.v1beta1.EstimateSwapExactAmountInWithPrimitiveTypesRequest")
	...
	proto.RegisterType((*EstimateSwapExactAmountOutWithPrimitiveTypesRequest)(nil), "merlin.poolmanager.v1beta1.EstimateSwapExactAmountOutWithPrimitiveTypesRequest")
...
type QueryClient interface {
	...
	// together as pairs.
	// example usage:
	// http://0.0.0.0:1317/merlin/poolmanager/v1beta1/1/estimate/
...
func (c *queryClient) EstimateSwapExactAmountInWithPrimitiveTypes(ctx context.Context, in *EstimateSwapExactAmountInWithPrimitiveTypesRequest, opts ...grpc.CallOption) (*EstimateSwapExactAmountInResponse, error) {
	out := new(EstimateSwapExactAmountInResponse)
	err := c.cc.Invoke(ctx, "/merlin.poolmanager.v1beta1.Query/EstimateSwapExactAmountInWithPrimitiveTypes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) EstimateSwapExactAmountOutWithPrimitiveTypes(ctx context.Context, in *EstimateSwapExactAmountOutWithPrimitiveTypesRequest, opts ...grpc.CallOption) (*EstimateSwapExactAmountOutResponse, error) {
	out := new(EstimateSwapExactAmountOutResponse)
	err := c.cc.Invoke(ctx, "/merlin.poolmanager.v1beta1.Query/EstimateSwapExactAmountOutWithPrimitiveTypes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_EstimateSwapExactAmountInWithPrimitiveTypes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.poolmanager.v1beta1.Query/EstimateSwapExactAmountInWithPrimitiveTypes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_EstimateSwapExactAmountOutWithPrimitiveTypes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.poolmanager.v1beta1.Query/EstimateSwapExactAmountOutWithPrimitiveTypes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
